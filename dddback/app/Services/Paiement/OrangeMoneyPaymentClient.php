...
class OrangeMoneyPaymentClient
{
    public function createPaymentUrl(CahierAccesAchat $achat, AppelOffre $appelOffre): string
    {
        ...
        $payload = [
            ...
            'currency' => 'XOF',
            'return_url' => $frontend.'/appels-offres/'.$appelOffre->id.'?paiement=orange_money&statut=success',
            'cancel_url' => $frontend.'/appels-offres/'.$appelOffre->id.'?paiement=orange_money&statut=annule',
