...
@section('body')
    ...
    <p>Après une analyse approfondie des dossiers reçus pour l'appel d'offres <strong>{{ $candidature->appelOffre->titre }}</strong>, nous avons le regret de vous informer que le vôtre n'a pas été retenu.</p>
    <p class="muted"><strong>Référence de l'appel d'offres :</strong> {{ $candidature->appelOffre->reference }}</p>
    <p>Nous vous encourageons à consulter nos prochains avis d'appel d'offres et à vous conformer aux modalités de dépôt des plis.</p>
    <div class="btn-wrap">
