...
@section('body')
    ...
    <p>Nous avons bien reçu votre dossier pour l'appel d'offres <strong>{{ $candidature->appelOffre->titre }}</strong>.</p>
    <p class="muted">
    ...
    <p>Votre dossier est en cours de traitement. Vous serez notifié de son évolution dans le portail.</p>
    <div class="btn-wrap">
